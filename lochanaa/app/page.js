    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-linear-to-r from-purple-400 via-violet-500 to-pink-400 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/work" className="px-8 py-4 bg-linear-to-r from-blue-900 to-purple-600/50 text-white font-semibold rounded-full hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25">
              View My Work
            </Link>
...
<section id="projects" className="py-20 relative">
      ...
      <section id="contact" className="py-20 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Let us Work Together</h2>
          <div className="w-24 h-1 bg-linear-to-r from-blue-500 to-purple-600 mx-auto rounded-full mb-8"></div>
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Have a project in mind? I would love to hear about it and discuss how we can bring your ideas to life.
          </p>
          <button className="px-8 py-4 bg-linear-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-full hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25">
            Get In Touch
          </button>
        </div>
      </section>
